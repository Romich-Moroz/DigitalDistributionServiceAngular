...
% из-за этой строчки сейчас происходит ошибка: Counter 'lstlisting' not defined
...
\captionsetup[table]{skip=0pt,format=hang} %минимальное расстояние между подписью и таблицей, новая строка подписи таблицы будет буква под буквой